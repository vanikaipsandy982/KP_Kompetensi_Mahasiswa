                ...
                <div>
                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="email" class="form-control" id="inputAddress" placeholder="masukan email">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <a href="/isiSurvey/Category1" class="btn btn-light" role="button" aria-pressed="true">Isi Survey</a>
                        </div>
                    </form>
                    <br>
                    <br>
