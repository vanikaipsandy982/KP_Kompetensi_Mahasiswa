                    ...
                    <form method="POST" action="{{ url('/listJadwal/store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="nama_kelompok">
                                <option></option>
                                @foreach($pengelompokan as $value)
                        ...
                        <!--Jadwal Mentoring-->
                        <div class="form-group">
                            <label for="jadwal">Jadwal Mentoring</label>
                            <input type="text" class="form-control" placeholder="Jadwal Mentoring" name="jadwalMentor">
                        </div>
                        <!--Keterangan-->
                        <div class="form-group">
                            <label for="keterangan">Keterangan</label>
                            <input type="text" class="form-control" placeholder="Keterangan" name="keteranganMentor">
                        </div>
                        <!--Nama Mentor-->
                        <div class="form-group">
                            <label for="nama_mentor">Nama Mentor</label>
                            <select class="form-control" name="nama_mentor">
                                <option></option>
                                @foreach($mahasiswa as $value)
                                    <option value="{{$value->id}}">{{$value->nama_mahasiswa}}</option>
                                @endforeach
                            </select>
                        </div>
...
<script>
    $(document).ready(function (){
        $('.btn-edit').on('click',function (){
            ...
            $('input[name="jadwalLama"]').val(jadwalLama);
