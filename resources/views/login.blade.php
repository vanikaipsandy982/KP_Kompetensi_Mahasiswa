...
@section('css')
    <link rel="icon" type="{{asset('templateLogin/image/png" href="images/icons/favicon.ico')}}">
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form-title" style="background-image: url('{{asset('templateLogin/images/bg-01.jpg')}}');">
