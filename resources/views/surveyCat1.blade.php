...
<section id="hero" class="gallery">
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            ...
            <p style="font-size: 30px" >Pertanyaan 1</p>
            ...
            <hr>
                <!--pertanyaan 2-->
                <p style="font-size: 30px" >Pertanyaan 2</p>
            ...
            <hr>
            <!--pertanyaan 3-->
            <p style="font-size: 30px" >Pertanyaan 3</p>

            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOption3" id="inlineRadio1" value="option1">
                <label class="form-check-label" for="inlineRadio1">1</label>
            </div>
            <div class="form-check form-check-inline">
            ...
            <hr>
            <!--pertanyaan 4-->
            <p style="font-size: 30px" >Pertanyaan 4</p>
            ...
            <hr>
            <!--pertanyaan 5-->
            <p style="font-size: 30px" >Pertanyaan 5</p>
            ...
            <hr>
            <!--pertanyaan 6-->
            <p style="font-size: 30px" >Pertanyaan 6</p>
            ...
            <hr>
            <!--pertanyaan 7-->
            <p style="font-size: 30px" >Pertanyaan 7</p>
            ...
            <hr>
            <!--pertanyaan 8-->
            <p style="font-size: 30px" >Pertanyaan 8</p>
            ...
            <hr>
            <!--pertanyaan 9-->
            <p style="font-size: 30px" >Pertanyaan 9</p>
            ...
            <hr>
            <!--pertanyaan 10-->
            <p style="font-size: 30px" >Pertanyaan 10</p>
